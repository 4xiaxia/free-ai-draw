...
const zhTranslations: Translations = {
  ...
  'dialog.autodraw.ca.title': '意图选择',
  'dialog.autodraw.ca.kicker': 'intent flow',
  'dialog.autodraw.ca.hint':
    '让模型先读一遍方法描述，提出几组意图选项，尤其确认主要实体和模块，帮助第一步生图收敛风格和表达重点。',
  'dialog.autodraw.ca.readyHint':
    '已形成一组生成偏好；开始生成时会作为结构化上下文传给第一步生图模型。',
  'dialog.autodraw.ca.skippedHint':
    '已跳过意图选择；开始生成时只使用原始方法描述。',
  'dialog.autodraw.ca.generate': '生成意图选项',
  'dialog.autodraw.ca.generating': '生成中...',
  'dialog.autodraw.ca.regenerate': '重新选择意图',
  'dialog.autodraw.ca.skip': '跳过',
  'dialog.autodraw.ca.clear': '清空',
  'dialog.autodraw.ca.language': '返回语言',
  'dialog.autodraw.ca.languageChinese': '中文',
  'dialog.autodraw.ca.languageEnglish': 'English',
  'dialog.autodraw.ca.recommended': '推荐',
  'dialog.autodraw.ca.summary': '已确认',
  'dialog.autodraw.ca.error': '意图选项生成失败',
  'dialog.autodraw.ca.status.idle': '待选择',
  'dialog.autodraw.ca.status.loading': '思考中',
  'dialog.autodraw.ca.status.ready': '已确认',
  'dialog.autodraw.ca.status.skipped': '已跳过',
  'dialog.autodraw.ca.status.error': '失败',
  ...
  'dialog.autodraw.caApiKey': '意图选择 API Key',
  'dialog.autodraw.caBaseUrl': '意图选择 Base URL',
  'dialog.autodraw.caModel': '意图选择模型',
  ...
  'dialog.autodraw.figureLanguage': '图中文字',
  'dialog.autodraw.figureLanguageEnglish': '英文图',
  'dialog.autodraw.figureLanguageChinese': '中文图',
  'dialog.autodraw.figureLanguageHintEnglish':
    '复用原有生图提示词，默认生成英文标注和标题。',
  'dialog.autodraw.figureLanguageHintChinese':
    '步骤一会要求模型使用中文标签、标题和中文字体风格。',
  'dialog.autodraw.figureLanguageHintSource':
    '上传原图会跳过步骤一，所以这里不会参与处理。',
  ...
  'dialog.autodraw.processTrace.button': '过程卡片',
  'dialog.autodraw.processTrace.loading': '读取中...',
  'dialog.autodraw.processTrace.kicker': 'prompt & data flow',
  'dialog.autodraw.processTrace.title': '全过程提示词与数据流',
  'dialog.autodraw.processTrace.close': '收起',
  'dialog.autodraw.processTrace.inputs': '输入',
  'dialog.autodraw.processTrace.outputs': '输出',
  'dialog.autodraw.processTrace.prompt': '阶段 Prompt',
  'dialog.autodraw.processTrace.stage': '阶段',
  'dialog.autodraw.processTrace.noJob': '请先启动或载入一个 AutoDraw 任务。',
  'dialog.autodraw.processTrace.unavailable':
    '过程卡片暂不可用，任务开始后会逐步写入 process_trace.json。',
