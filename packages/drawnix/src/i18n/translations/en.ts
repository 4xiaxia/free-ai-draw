...
const enTranslations: Translations = {
  ...
  'dialog.autodraw.ca.title': 'Intent Selection',
  'dialog.autodraw.ca.kicker': 'intent flow',
  'dialog.autodraw.ca.hint':
    'Let the model read the method first and produce intent options, especially the main entities and modules, so the first image generation step has a clearer direction.',
  'dialog.autodraw.ca.readyHint':
    'A generation direction is ready; it will be sent as structured context to the first image model step.',
  'dialog.autodraw.ca.skippedHint':
    'Intent selection is skipped; generation will use the original method text only.',
  'dialog.autodraw.ca.generate': 'Generate Intent Options',
  'dialog.autodraw.ca.generating': 'Thinking...',
  'dialog.autodraw.ca.regenerate': 'Refresh Intent',
  'dialog.autodraw.ca.skip': 'Skip',
  'dialog.autodraw.ca.clear': 'Clear',
  'dialog.autodraw.ca.language': 'Response Language',
  'dialog.autodraw.ca.languageChinese': '中文',
  'dialog.autodraw.ca.languageEnglish': 'English',
  'dialog.autodraw.ca.recommended': 'Recommended',
  'dialog.autodraw.ca.summary': 'Confirmed',
  'dialog.autodraw.ca.error': 'Failed to generate intent options',
  'dialog.autodraw.ca.status.idle': 'Pending',
  'dialog.autodraw.ca.status.loading': 'Thinking',
  'dialog.autodraw.ca.status.ready': 'Ready',
  'dialog.autodraw.ca.status.skipped': 'Skipped',
  'dialog.autodraw.ca.status.error': 'Failed',
  ...
  'dialog.autodraw.caApiKey': 'Intent API Key',
  'dialog.autodraw.caBaseUrl': 'Intent Base URL',
  'dialog.autodraw.caModel': 'Intent Model',
  ...
  'dialog.autodraw.figureLanguage': 'Figure Text',
  'dialog.autodraw.figureLanguageEnglish': 'English',
  'dialog.autodraw.figureLanguageChinese': 'Chinese',
  'dialog.autodraw.figureLanguageHintEnglish':
    'Reuse the existing image prompt and generate English labels and titles by default.',
  'dialog.autodraw.figureLanguageHintChinese':
    'Stage 1 asks the model to use Chinese labels, titles, and Chinese-capable typography.',
  'dialog.autodraw.figureLanguageHintSource':
    'Source figure uploads skip stage 1, so this setting is ignored.',
  ...
  'dialog.autodraw.processTrace.button': 'Process Card',
  'dialog.autodraw.processTrace.loading': 'Loading...',
  'dialog.autodraw.processTrace.kicker': 'prompt & data flow',
  'dialog.autodraw.processTrace.title': 'Full Prompts and Data Flow',
  'dialog.autodraw.processTrace.close': 'Collapse',
  'dialog.autodraw.processTrace.inputs': 'Inputs',
  'dialog.autodraw.processTrace.outputs': 'Outputs',
  'dialog.autodraw.processTrace.prompt': 'Stage Prompt',
  'dialog.autodraw.processTrace.stage': 'Stage',
  'dialog.autodraw.processTrace.noJob': 'Start or load an AutoDraw job first.',
  'dialog.autodraw.processTrace.unavailable':
    'The process card is not available yet. process_trace.json is written as the job runs.',
