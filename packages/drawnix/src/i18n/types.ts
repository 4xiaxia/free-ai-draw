...
export interface Translations {
  ...
  'dialog.autodraw.ca.title': string;
  'dialog.autodraw.ca.kicker': string;
  'dialog.autodraw.ca.hint': string;
  'dialog.autodraw.ca.readyHint': string;
  'dialog.autodraw.ca.skippedHint': string;
  'dialog.autodraw.ca.generate': string;
  'dialog.autodraw.ca.generating': string;
  'dialog.autodraw.ca.regenerate': string;
  'dialog.autodraw.ca.skip': string;
  'dialog.autodraw.ca.clear': string;
  'dialog.autodraw.ca.language': string;
  'dialog.autodraw.ca.languageChinese': string;
  'dialog.autodraw.ca.languageEnglish': string;
  'dialog.autodraw.ca.recommended': string;
  'dialog.autodraw.ca.summary': string;
  'dialog.autodraw.ca.error': string;
  'dialog.autodraw.ca.status.idle': string;
  'dialog.autodraw.ca.status.loading': string;
  'dialog.autodraw.ca.status.ready': string;
  'dialog.autodraw.ca.status.skipped': string;
  'dialog.autodraw.ca.status.error': string;
  ...
  'dialog.autodraw.caApiKey': string;
  'dialog.autodraw.caBaseUrl': string;
  'dialog.autodraw.caModel': string;
  'dialog.autodraw.imageModel': string;
  'dialog.autodraw.imageSize': string;
  'dialog.autodraw.imageSizeHint': string;
  'dialog.autodraw.figureLanguage': string;
  'dialog.autodraw.figureLanguageEnglish': string;
  'dialog.autodraw.figureLanguageChinese': string;
  'dialog.autodraw.figureLanguageHintEnglish': string;
  'dialog.autodraw.figureLanguageHintChinese': string;
  'dialog.autodraw.figureLanguageHintSource': string;
  ...
  'dialog.autodraw.processTrace.button': string;
  'dialog.autodraw.processTrace.loading': string;
  'dialog.autodraw.processTrace.kicker': string;
  'dialog.autodraw.processTrace.title': string;
  'dialog.autodraw.processTrace.close': string;
  'dialog.autodraw.processTrace.inputs': string;
  'dialog.autodraw.processTrace.outputs': string;
  'dialog.autodraw.processTrace.prompt': string;
  'dialog.autodraw.processTrace.stage': string;
  'dialog.autodraw.processTrace.noJob': string;
  'dialog.autodraw.processTrace.unavailable': string;
